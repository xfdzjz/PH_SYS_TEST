...
ptaParsers = {
    'S2.1.1': 'vol is (\S+)',
    'S2.1.2': 'vol is (\S+)',
    'S2.1.3': 'VCC is (\S+)v fre is (\S+), duty is (\S+)',
    'S2.1.4': 'VCC is (\S+)v fre is (\S+), duty is (\S+)',
    'S2.1.5': 'VCC is (\S+)v fre is (\S+), duty is (\S+)',
    'S2.1.6': 'ready:(\S+)mv VCC is (\S+)v avg is (\S+)',
    'S2.2.1': 'VCC is (\S+)v vol is (\S+)',
    'S2.2.3': 'vol is (\S+)',
    'S2.2.4': 'VCC is (\S+)v vol is (\S+)',
    'S2.2.6': 'vol is (\S+)',
